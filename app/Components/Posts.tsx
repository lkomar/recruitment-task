    ...
    <>
      <div className="mb-8 flex justify-center">
        <Search
          ...
          className="mx-4 w-full rounded-md border-[1px] border-solid border-sky-600 px-4 py-2 text-black dark:border-2 dark:border-sky-700 dark:bg-gray-200 md:w-96"
        />
      </div>
